...
'''
# defining admin variable
is_admin: bool
user_login: bool


# making decorator to insure that no other admin can access sites
def admin_only(fun):
    @wraps(fun)
...
class Comment(db.Model):
    ...
    post_comment: Mapped["BlogPost"] = relationship(back_populates="comments")
...
def get_all_posts():
    ...
    if current_user.is_authenticated:
        ...
        user_login = False
    return render_template("index.html", all_posts=posts, login=user_login, is_admin=is_admin)
...
def show_post(post_id):
    ...
    return render_template("post.html", post=requested_post, is_admin=is_admin,
                           form=form, login=user_login, gravatar_url=gravatar_url)
